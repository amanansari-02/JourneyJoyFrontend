...
function PropertyView() {
    ...
    function HotelDetails() {
        return (
            <div>
                <Typography variant='lead' className='flex flex-col md:flex-row md:justify-between'>
                    ...
                    <Card className='mt-6 md:w-[38%] w-full'>
                        <CardBody>
                            <Typography variant="h5" color="blue-gray" className="mb-2">
                                Amenities
                            </Typography>
    ...
    return (
        <div className="max-w-6xl mx-auto p-4">
            <Breadcrumbs className='m-4'>
                <Link to="/admin-dashboard/property" className="opacity-60" >
                    <svg
